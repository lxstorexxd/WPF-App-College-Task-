...
namespace TestProject.Services
{
    public static class AuthenticationService
    {
        private static List<User> _users = new List<User>
        {
            ...
            new User { UserId = 3, Username = "sasha2004", Password = "sasha2004", FirstName = "Сашка", LastName = "Круглый", BirthDate = new DateTime(2004, 5, 5), Role = "Администратор", AvatarPath = "/assets/sasha2004.jpg" },
            new User { UserId = 4, Username = "vlad2004", Password = "vlad2004", FirstName = "Влад", LastName = "Попов", BirthDate = new DateTime(2004, 10, 14), Role = "Администратор", AvatarPath = "/assets/default-avatar.jpeg" },
            new User { UserId = 4, Username = "tropa2004", Password = "tropa2004", FirstName = "Аня", LastName = "Тропиночка", BirthDate = new DateTime(2004, 10, 14), Role = "Администратор", AvatarPath = "/assets/tropa2004.jpg" },
